...
export const options = {
    ...
    B: {type: 'usually', success: 3, faild: -3, target: {C: 2}, val: 'B（-3分，如果至少2人选了C，改为+3分）'},
    C: {type: 'usually', success: 3, faild: -3, target: {D: 2}, val: 'C（-3分，如果至少2人选了D，改为+3分）'},
    D: {type: 'usually', success: 3, faild: -3, target: {B: 2}, val: 'D（-3分，如果至少2人选了B，改为+3分）'},
};
// 没有选的人的分数
