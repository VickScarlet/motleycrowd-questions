...
export const options = {
    ...
    B: {type: 'usually', success: 3, faild: -3, target: {C: 3},        val: 'B（-3分，如果至少3人选了C，改为+3分）'},
    C: {type: 'usually', success: 3, faild: -3, target: {B: 3},        val: 'C（-3分，如果至少3人选了B，改为+3分）'},
    D: {type: 'special', success: 2, faild:  0, target: {B: 3, C: 3}, val: 'D（如果B和C都有至少3人，+2分）', rate: 500},
};
// 没有选的人的分数
